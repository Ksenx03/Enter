...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"Добро пожаловать в MyTime!";
			// 
			// linkLabel1
			// 
			...
			this->linkLabel1->Text = L"У вас еще нет аккаунта на MyTime\? \r\n Зарегистрируйтесь сейчас!";
			...
			this->button3->Text = L"Показать пароль";
...
#pragma endregion
	...
	bool Login_Password(String^ login, String^ password) {
		if (login == "Kseniya" && password == "159132") {
			...
			MessageBox::Show(this, "Введены неверные данные", "Ошибка", MessageBoxButtons::OK, 
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	if (textBox2->PasswordChar == '*') {
		// Если пароль скрыт, покажем его
		textBox2->PasswordChar = '\0';
	}
	else {
		// Если пароль виден, скроем его
		textBox2->PasswordChar = '*';
	}
}
private: System::Void textBox2_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	// При изменении текста в TextBox с паролем
	// Скрываем пароль, если он был показан
	textBox2->PasswordChar = '*';
}
private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
}
