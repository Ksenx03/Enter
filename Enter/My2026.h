...
namespace Enter {
	...
	/// Сводка для My2026
	/// </summary>
	public ref class My2026 : public System::Windows::Forms::Form
	{
	public:
		My2026(void)
		{
			...
			//
			this->checkedListBox8->ItemCheck += gcnew System::Windows::Forms::ItemCheckEventHandler(this, &My2026::checkedListBox_ItemCheck);
			this->checkedListBox9->ItemCheck += gcnew System::Windows::Forms::ItemCheckEventHandler(this, &My2026::checkedListBox_ItemCheck);
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->checkedListBox8->Items->AddRange(gcnew cli::array< System::Object^  >(12) {
				L"Styczen", L"Luty ", L"Marzec ", L"Kwiecien",
					L"Maj ", L"Czerwiec ", L"Lipiec ", L"Sierpien ", L"Wrzesien ", L"Pazdziernik ", L"Listopad ", L"Grudzien "
			});
			this->checkedListBox8->Location = System::Drawing::Point(6, 46);
			this->checkedListBox8->Name = L"checkedListBox8";
			this->checkedListBox8->Size = System::Drawing::Size(155, 214);
			this->checkedListBox8->TabIndex = 2;
			// 
			// checkedListBox9
			// 
			this->checkedListBox9->FormattingEnabled = true;
			this->checkedListBox9->Items->AddRange(gcnew cli::array< System::Object^  >(12) {
				L"Styczen", L"Luty ", L"Marzec ", L"Kwiecien",
					L"Maj ", L"Czerwiec ", L"Lipiec ", L"Sierpien ", L"Wrzesien ", L"Pazdziernik ", L"Listopad ", L"Grudzien "
			});
			this->checkedListBox9->Location = System::Drawing::Point(167, 46);
			this->checkedListBox9->Name = L"checkedListBox9";
			this->checkedListBox9->Size = System::Drawing::Size(155, 214);
			...
			this->Name = L"My2026";
			this->Text = L"My2026";
			this->Load += gcnew System::EventHandler(this, &My2026::My2026_Load);
...
#pragma endregion
	private:
		System::Void My2026_Load(System::Object^ sender, System::EventArgs^ e) {
			LoadCheckedListBoxState(this->checkedListBox8, "checkedListBox8_state.txt");
			LoadCheckedListBoxState(this->checkedListBox9, "checkedListBox9_state.txt");
		}
		...
		System::Void checkedListBox_ItemCheck(System::Object^ sender, System::Windows::Forms::ItemCheckEventArgs^ e) {
			...
			String^ fileName = (checkedListBox == this->checkedListBox8) ? "checkedListBox8_state.txt" : "checkedListBox9_state.txt";
